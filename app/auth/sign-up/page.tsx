      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
          <div className="flex gap-3 mb-6">
            <button type="button" onClick={() => setRole('golfer')}
              className={`flex-1 flex flex-col items-center gap-2 rounded-xl border-2 p-4 transition-all ${
                role === 'golfer' ? 'border-primary bg-primary/5 text-primary' : 'border-border text-muted-foreground hover:border-primary/40'
              }`}>
            ...
            <button type="button" onClick={() => setRole('manager')}
              className={`flex-1 flex flex-col items-center gap-2 rounded-xl border-2 p-4 transition-all ${
                role === 'manager' ? 'border-primary bg-primary/5 text-primary' : 'border-border text-muted-foreground hover:border-primary/40'
              }`}>
          ...
          <form onSubmit={handleSignUp} className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="displayName" placeholder={role === 'manager' ? 'Pebble Beach Golf Club' : 'Tiger Woods'}
